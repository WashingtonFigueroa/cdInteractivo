 ...
 * @author pc
 */
public class capitulo111 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MÉTODO DE GAUSS");
    ...
    private void btnplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnplayActionPerformed
        if (s == false) {
            sonido = java.applet.Applet.newAudioClip(getClass().getResource("../audios/MÉTODO DE GAUSS.wav"));
            sonido.play();
            s = true;
        }
