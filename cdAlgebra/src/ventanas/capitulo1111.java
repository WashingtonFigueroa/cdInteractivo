 ...
 * @author pc
 */
public class capitulo1111 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnPrimero, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 550, 60, 60));

        jLabel2.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ELIMINACIÓN DE GAUSS-JORDAN");
        ...
        jPanel1.add(btnAnterior, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 550, 60, 60));
    ...
    private void btnplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnplayActionPerformed
        if (s == false) {
            sonido = java.applet.Applet.newAudioClip(getClass().getResource("../audios/ELIMINACION DE GAUSS JORDAN.wav"));
            sonido.play();
            s = true;
        }
