 ...
 * @author pc
 */
public class capitulo444444 extends javax.swing.JInternalFrame {

    /**
     * Creates new form capitulo1
     */
    public capitulo444444() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ESPACIOS DUALES");
        ...
        jTextArea1.setText("Definición \n\nSea V un K-espacio vectorial. Se llama espacio dual de V, y se lo nota V *, al K-espacio vectorial  V * = HomK (V, K) = {f: V -> K / f es una transformación lineal}.\n\nSegún vimos en la Sección 3.7, si dim V = n, dadas B una base de V y B0 una base de K, se tiene que Γ : HomK(V, K) -> K1×n definida por Γ(f) = |f|BB0 , es un isomorfismo. \nEn consecuencia, dim (V ∗) = dim (K1×n) = n = dim V.\n");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 750, 240));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("https://www.youtube.com/watch?v=jyTeyZeUtvg");
    ...
    private void btnAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnteriorActionPerformed
        ...
        this.setVisible(false);
        capitulo44444 c444444 = new capitulo44444();
